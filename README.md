...
* Cálculo automatizado de juros compostos aplicados a dividendos.
* Simulação de crescimento de patrimônio acumulado ao longo do tempo.
* Estimativa de renda mensal (dividendos) baseada na cotação e rendimento médio.
